...
import { Library, ChevronLeft, ChevronRight, Menu } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`sm:hidden p-2 ${theme.textSecondary} hover:bg-white/10 rounded-lg`}
              >
                <Menu className="h-5 w-5" />
              </button>
            </div>
            <div className={`${showMobileSearch ? 'block' : 'hidden'} sm:block w-full sm:w-auto`}>
