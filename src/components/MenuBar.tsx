    ...
    <>
      ...
      <div className="fixed top-4 right-4 z-50">
        <button
          ...
          className={`${theme.buttonBg} p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-white`}
        >
            ...
            <div className="flex flex-col gap-2 min-w-[200px]">
              ...
              <div className="px-4 py-2">
                <p className={`text-xs flex items-center gap-1 ${theme.textSecondary}`}>
                  Made with <Heart className="h-3 w-3 text-red-500" /> by Team
                </p>
              </div>
            </div>
          </div>
